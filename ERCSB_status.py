...
with st.expander("🔍 ดูข้อมูลโครงการทั้งหมดแบบละเอียด"):
    # 1. เลือกคอลัมน์ที่ต้องการแสดง
    display_df = filtered_df[['เลขที่โครงการ', 'ชื่อโครงการ', 'ผู้ยื่นโครงการ', 'รูปแบบการซื้อขาย', 'โครงข่าย', 'สถานะ', 'โครงการ']].copy()
    
    # 2. ปรับให้ตัวเลข Index ด้านหน้าเริ่มที่ 1 (แทนที่จะเป็น 0)
